...
public class SemanticChecks implements Visitor {
	...
	private void handleMethod(Method method, boolean isVirtual)
		...
		if (superClassSymTable != null && superClassSymTable.isClassTable()) {
			...
			if (!TypeAdapter.adaptType(method).equals(
	...
	// */
	// public void HandleError(String err_msg, ASTNode node) throws
	// SemanticError {
	// if (node != null) {
	...
	// }
	//
	// public boolean legalInitOfVar(Statement stmt, VariableLocation
	// varLocation) {
	//
